/**
 * rag-federated-pubmed — Phase 60 Plan 60-07 PubMed E-utilities federated adapter.
 *
...
// Re-export HandlerDeps for convenience (tests can import from index.ts or handler.ts)
