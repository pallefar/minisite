...
CHUNK_CONFIG=(
  ...
  "community-media   190 Phase 44 Plan 09: Mux player (~170 kB gz) + Mux uploader (~16 kB gz) + glue (~4 kB). If regressed: audit @mux/* import chain or defer player init via sync-defer.ts."
