...
#
# CLINIC_CEILING=36000 — Phase 30 verifier orphan-fix bump (2026-05-18).
...
# land in the clinic chunk. Initial Plan 30-05 measurement: 34,227 bytes gz (ceiling 35000).
# Verifier orphan-fix wired ClinicDashboardOverview into ClinicWorkspace (was unreachable
