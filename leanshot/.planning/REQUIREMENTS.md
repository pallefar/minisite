...
- [x] **COMPL-01**: Privacy policy is published and references all data collected (injections, photos, weight, mood, symptoms, AI conversations) — drafted in consultation with legal counsel
...
|-------------|-------|--------|
| COMPL-01 | Phase 7 — Compliance Foundations (Legal-Counsel-Led) | Complete |
