...
- [x] **COMMUNITY-03**: @mentions in posts + comments fire in-app + email notifications to mentioned user (respect notification_settings)
...
| COMMUNITY-03 | Phase 44 | Complete |
