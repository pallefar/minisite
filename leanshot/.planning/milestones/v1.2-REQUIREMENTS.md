# Requirements Archive: v1.2 Polished Launch + Full Monetization
...
| MOBILE-01 | Phase 16 | Deferred to v1.4 (descoped 2026-05-17 — P16 vendor closeout incomplete) |
| MOBILE-02 | Phase 16 | Deferred to v1.4 (descoped 2026-05-17 — P16 vendor closeout incomplete) |
| MOBILE-03 | Phase 16 | Deferred to v1.4 (descoped 2026-05-17 — P16 vendor closeout incomplete) |
| MOBILE-04 | Phase 16 | Deferred to v1.4 (descoped 2026-05-17 — P16 vendor closeout incomplete) |
| MOBILE-05 | Phase 16 | Deferred to v1.4 (descoped 2026-05-17 — P16 vendor closeout incomplete) |
| MOBILE-06 | Phase 16 | Deferred to v1.4 (descoped 2026-05-17 — P16 vendor closeout incomplete) |
| MOBILE-07 | Phase 16 | Deferred to v1.4 (descoped 2026-05-17 — P16 vendor closeout incomplete) |
| MOBILE-08 | Phase 16 | Deferred to v1.4 (descoped 2026-05-17 — P16 vendor closeout incomplete) |
| MOBILE-09 | Phase 16 | Deferred to v1.4 (descoped 2026-05-17 — P16 vendor closeout incomplete) |
| MOBILE-10 | Phase 16 | Deferred to v1.4 (descoped 2026-05-17 — P16 vendor closeout incomplete) |
...
| MONEY-06 | Phase 16 | Deferred to v1.4 (descoped 2026-05-17 — P16 vendor closeout incomplete) |
...
| ~~Phase 16~~ | ~~MOBILE-01..10, MONEY-06~~ — **deferred to v1.4 (2026-05-17, P16 vendor closeout incomplete)** | ~~11~~ |
...
| **v1.2 active total** | | **60** |
| **v1.4 deferred carry-over** | PUSH + HEALTH + AD + WATCH + ON-01 + MOBILE + MONEY-06 | **44** |
| **Original v1.2 scope** | | 104 |

**v1.2 coverage (after 2026-05-17 descope round 2):** 60 active REQ-IDs across 7 shipped phases (12/13/14/15/19/22/23). 44 REQ-IDs deferred to v1.4 milestone (Phases 16/17/18/20/21 + ON-01). User direction 2026-05-17: **"first I will verify and close 1.2 and then focus on additional features for 1.4. milstone 1.4 needs to forcus and close averything deffred and all tech debt"** — clarified 2026-05-17: **v1.3 is the next milestone (new features only); v1.4 absorbs deferred phases + all v1.2-era tech debt + additional new features.** Phase 16 also descoped 2026-05-17 round 2 (vendor closeout still in flight; full mobile shells ship in v1.4).
