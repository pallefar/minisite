...
- [ ] 38-06-PLAN.md — plan-personalize Edge Fn (rule-based, no LLM, p99<50ms)
...
- [ ] 38-09-PLAN.md — pg_cron schedules + TAXO event registration + ForYouCard + RelatedArticlesFooter + track-rec-click
