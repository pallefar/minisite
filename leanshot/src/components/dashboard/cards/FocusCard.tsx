    ...
    <Card span={12} variant="elevated" className="bg-[var(--color-primary-soft)] border-[var(--color-primary-soft)]">
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          <p className="text-[10px] font-bold uppercase tracking-[0.1em] text-[var(--color-primary)]">Today's focus</p>
          <h2 className="text-[18px] md:text-[20px] font-bold leading-tight tracking-tight mt-0.5">{focus.title}</h2>
          <p className="text-[13px] text-[var(--color-text-secondary)] mt-1.5 max-w-[60ch] leading-snug">{focus.body}</p>
        </div>
        <Button
          variant="primary"
          size="sm"
