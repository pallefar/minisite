...
export interface AffiliatePublicRow {
  ...
  /**
   * Phase 26 26-04 (AFFTIER-06): tier surfaced from the public view so the
   * resolver can route Gold partners to `LandingTemplateGold` regardless of
   * the legacy `template_choice` value. Optional + nullable so Phase 19
   * call-sites that pre-date Plan 26-01 (e.g. the existing Coach/Story/Method
   * vitest fixtures) still type-check.
   */
  tier?: 'standard' | 'gold' | 'lifetime' | null;
}
